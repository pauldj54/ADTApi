...
class DigitalTwinsEndpointOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~digitaltwins.models.DigitalTwinsEndpointResourcePaged[~digitaltwins.models.DigitalTwinsEndpointResource]
        :raises:
    ...
    def get(
        ...
        :rtype: ~digitaltwins.models.DigitalTwinsEndpointResource or
    ...
    def _create_or_update_initial(
            self, resource_group_name, resource_name, endpoint_name, endpoint_description, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def create_or_update(
            self, resource_group_name, resource_name, endpoint_name, endpoint_description, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :param endpoint_name: Name of Endpoint Resource.
        :type endpoint_name: str
        :param endpoint_description: The DigitalTwinsInstance endpoint
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~digitaltwins.models.DigitalTwinsEndpointResource]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~digitaltwins.models.DigitalTwinsEndpointResource]]
        :raises:
         :class:`ErrorResponseException<digitaltwins.models.ErrorResponseException>`
        """
