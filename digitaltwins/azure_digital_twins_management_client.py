...
class AzureDigitalTwinsManagementClientConfiguration(AzureConfiguration):
    ...
    def __init__(
        ...
        self.add_user_agent('ADTApi/{}'.format(VERSION))
...
class AzureDigitalTwinsManagementClient(SDKClient):
    ...
    :vartype digital_twins_endpoint: digitaltwins.operations.DigitalTwinsEndpointOperations
    :ivar operations: Operations operations
    :vartype operations: digitaltwins.operations.Operations
